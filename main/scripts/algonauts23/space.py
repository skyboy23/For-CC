...
from scripts.algonauts23 import ALGONAUTS_RAW_DIR, ROI_GROUPS, SUBS
from scripts.algonauts23.parcellation import Parcellation, load_fsaverage_schaefer
from scripts.algonauts23.surface import load_fsaverage_flat
...
class AlgonautsSpace:
    ...
    def __init__(self, sub: str, root: Union[str, Path] = ALGONAUTS_RAW_DIR):
        ...
        surf = load_fsaverage_flat()  # 327684
        mask, hemi_offset = load_challenge_mask(root, sub)  # mask 327684
