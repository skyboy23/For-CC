'''
--out_dir
/home/mashuxiao/code/43.algonauts23-main_BlobGPT/weights
'''
...
# from algonauts23 import Visualizer, plot_maps
...
class Args:
    ...
    n_components: int = HfArg(aliases=["-d"], default=4096, help="number of components")
